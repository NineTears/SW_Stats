...
SW_MEM_WARNING_THRESH = 10000000;
SW_TL_AUTO_THRESH = 4320; -- if using auto delete the time in hours when to delete
...
SW_DefaultBar = {
	...
	["SF"] = "SW_Filter_Group"; 	-- 默认显示队伍/团队的数据
	["ShowRank"] = 1; 				-- 默认显示序号
	["ShowNumber"] = 1; 			-- 默认显示总数
	["ShowPercent"] = 1; 			-- 默认显示百分比
	["UCC"] = 1; 					-- 默认显示职业颜色
	["PF"] = "SW_PF_MM"; 			-- 默认合并宠物的输出
};
-- default color vars
SW_Default_Colors = {
	["Damage"] = {1,0,0,1},
