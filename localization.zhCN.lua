...
SW_LocalizedGUI ={
	...
	["SW_BarSyncFrame_Title_Text"] = "自动投票设置",
...
--新增的鼠标提示
SW_GS_Tooltips["SW_Close"] = "关闭";
SW_GS_Tooltips["SW_Report"] = "发送报告";
SW_GS_Tooltips["SW_Settings"] = "设置当前监视框";
SW_GS_Tooltips["SW_TimeLine"] = "同步时间段设置";
...
SW_MiniIconMenu[2]["textShow"] = "显示统计窗口";
SW_MiniIconMenu[2]["textHide"] = "隐藏统计窗口";
...
SW_MiniIconMenu[5]["textShow"] = "自动投票设置";
SW_MiniIconMenu[5]["textHide"] = "隐藏投票设置";
...
SW_InfoTypes[2]["t"] = "有效每秒伤害-DPS (同步)";
SW_InfoTypes[2]["d"] = "可能和个人统计的DPS数值有些不同,因为采用团队'进入战斗'的计时器(可能成员在团队里的某些动作,比如假死)";
SW_InfoTypes[3]["t"] = "治疗列表 (同步)";
SW_InfoTypes[3]["d"] = "显示治疗列表. (包括过量治疗).";
SW_InfoTypes[4]["t"] = "每秒治疗量-HPS(同步)";
SW_InfoTypes[4]["d"] = "像每秒伤害那样的列表,不过显示的是治疗数据.";
SW_InfoTypes[5]["t"] = "受到伤害 (同步)";
SW_InfoTypes[5]["d"] = "显示受到的伤害列表. (谁受到最多伤害?)";
SW_InfoTypes[6]["t"] = "目标受伤类型 (不同步)";
SW_InfoTypes[6]["d"] = "显示受到伤害的类型. (玩家受到伤害的类型? 例如: 火,冰等等.)";
SW_InfoTypes[7]["t"] = "团队受伤类型 (不同步)";
SW_InfoTypes[7]["d"] = "显示团队受到的伤害类型.(团队受到的伤害类型? 例如: 火,冰等等.) 注意: 使用职业过滤.";
SW_InfoTypes[8]["t"] = "受到治疗 (同步)";
SW_InfoTypes[8]["d"] = "显示受到治疗的目标. (谁得到最多治疗?)";
SW_InfoTypes[9]["t"] = "驱散次数(同步)";
SW_InfoTypes[9]["d"] = "某人解除的诅咒?:"..SW_GetSpellList();
SW_InfoTypes[10]["t"] = "死亡次数 (同步)";
SW_InfoTypes[10]["d"] = "哪些人经常死亡? 这个计数统计死亡的次数!";
SW_InfoTypes[11]["t"] = "抵抗率统计(不同步)";
SW_InfoTypes[11]["d"] = "显示对各种伤害类型的抵抗百分比";
SW_InfoTypes[12]["t"] = "详情 (不同步)";
SW_InfoTypes[12]["d"] = "详细的技能信息.(使用了什么技能?) 括号中的数字表示此技能造成的最大伤害/治疗";
